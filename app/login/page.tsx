    ...
    async function onSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            if (error) {
                ...
                // If email confirmation is ON, Supabase won’t sign you in immediately.
                // We show a friendly message; the onAuthStateChange in parent will handle instant login if disabled.
                if (!data.session) {
                    setMsg('Check your email to confirm your account. You’ll be redirected after confirming.')
                } else {
                    // session exists => instance allows immediate sign-in after sign-up
                    // Parent listener will redirect automatically.
